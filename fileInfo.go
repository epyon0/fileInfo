...
var SignatureMap map[uint]FileSignature = map[uint]FileSignature{
	...
	47: {Extension:   []string{"jpg", "jpeg"},
		Offset:      0,
		Signatures:  [][]byte{{0xFF, 0xD8, 0xFF, 0xDB}, {0xFF, 0xD8, 0xFF, 0xE0, 0x00, 0x10, 0x4A, 0x46, 0x49, 0x46, 0x00, 0x01}, {0xFF, 0xD8, 0xFF, 0xEE}, {0xFF, 0xD8, 0xFF, 0xE1, 0x??, 0x??, 0x45, 0x78, 0x69, 0x66, 0x00, 0x00}},
		Description: "JPEG raw or in the JFIF or Exif file format",
		ExcludeBytes: []int64{4, 4, 4, 5}},
	48: {Extension:   []string{"jpg"},
		Offset:      0,
		Signatures:  [][]byte{{0xFF, 0xD8, 0xFF, 0xE0}},
		Description: "JPEG raw or in the JFIF or Exif file format"},
	49: {Extension:   []string{"jp2", "j2k", "jpf", },
		Offset:      0,
		Signatures:  [][]byte{{}},
		Description: ""},
}
